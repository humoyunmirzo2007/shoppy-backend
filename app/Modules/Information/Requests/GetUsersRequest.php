...
use App\Modules\Information\Enums\UserPositionEnum;
...
class GetUsersRequest extends MainRequest
{
    public function rules(): array
    {
        return [
            ...
            'filters.position' => ['nullable', 'string', Rule::in(UserPositionEnum::cases())],
        ];
    }
    ...
    public function messages(): array
    {
        return [
            ...
            'filters.position.in' => 'Lavozim noto\'g\'ri',
        ];
    }
}
